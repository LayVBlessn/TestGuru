...
ActiveRecord::Schema.define(version: 2021_12_12_154238) do
  ...
  create_table "questions", force: :cascade do |t|
    ...
    t.integer "responce_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["responce_id"], name: "index_questions_on_responce_id"
  end
  ...
  add_foreign_key "questions", "responces"
